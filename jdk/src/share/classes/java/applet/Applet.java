...
/**
 * 一个applet是一个不能自己启动的小程序，但是它可以嵌入到另一个应用程序里面。
 * <p>
 * <code>Applet</code> 类必须是要嵌入Web页面或由Java Applet Viewer查看的任何小程序的超类。
 *  <code>Applet</code> 类提供了applet与其环境之间的标准接口。
 *
...
public class Applet extends Panel {
     ...
     * 构造一个新的小程序。
     * <p>
     * 注意：在<code>java.applet.Applet</code>里面有很多方法，
